...
public class ProductionConfigurationStore implements SidecarConfigurationStore {
    ...
    ProductionConfigurationStore() {
        this.compiler = new SidecarRuntimeCompiler();
    }
    ...
    @Override
    public void acceptConfigurationChange(SidecarInputPoint point, String serviceId, String endpointId, SidecarConfiguration cfg) {
        ConfigKey key = new ConfigKey(serviceId, endpointId, point);
