...
public interface SidecarConfigurationStore {
     ...
     * @param point point, either {@link SidecarInputPoint#PreProcessor} or {@link SidecarInputPoint#PostProcessor}
     * @param serviceId Id of the Mashery service
     * @param endpointID Id of the endpoint service
     * @param cfg Configuration object.
     */
    void acceptConfigurationChange(SidecarInputPoint point, String serviceId, String endpointID, SidecarConfiguration cfg);
